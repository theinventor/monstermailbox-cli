...
- mmb expect --from EMAIL_OR_DOMAIN [--subject-regex REGEX] [--window 7d] — predeclare expected verification mail; the CLI sends canonical `domain`, optional `subject_regex`, `purpose`, and `expires_in` fields.
